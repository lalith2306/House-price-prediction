...
Original file is located at
    https://colab.research.google.com/drive/1U47MqCOsxuo0LM-NP4C1nIMS39oWncOl
"""
...
# Assuming you have already defined and split your data into X_train, X_valid, Y_train, Y_valid
...
print("Random Forest MAPE:", mape_RFR)
...
mape_cb = mean_absolute_percentage_error(Y_valid, Y_pred_cb)
r2_cb = r2_score(Y_valid, Y_pred_cb)
print("CatBoost MAPE:", mape_cb)
print("CatBoost R2 Score:", r2_cb)
...
# R2 scores for each algorithm
r2_scores = [r2_RFR, r2_LR, r2_cb]
algorithms = ['Random Forest', 'Linear Regression', 'CatBoost']
